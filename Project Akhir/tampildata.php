...
<body style="background: linear-gradient(to right, #e0f7fa, #fff3e0);">
    ...
    <!-- tabel -->
    <div class="tabeldata">
        <a href="tambah.php">KEMBALI KE FORM</a>
        <br>
        <table border="1" style="background: white;">
            ...
            <?php
            include 'koneksi.php';
            $crud_fitness = mysqli_query($koneksi, "select * from crud_fitness");
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $d['jumlah_alat']; ?></td>
                    <td><?php echo $d['secbaru']; ?></td>
                    <td><?php echo $d['asal_alat']; ?></td>
                    <td>
